...
A software engineering student building full-stack systems and cloud-native applications, with a background in robotics.
...
**Cloud & Messaging:** Azure (Service Bus · Table Storage · Maps) · Docker  
**Automation:** UiPath (RPA)  
**Tools:** Git · Gradle · .NET 8 · JOGL
...
- Working through the NeetCode DSA roadmap (arrays → trees → graphs → DP)
- Exploring cloud-native patterns with Azure
